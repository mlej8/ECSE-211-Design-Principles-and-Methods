...
public class NavigationWithObstacles implements Runnable {
    ...
    private static NavigationWithObstacles navigator;
     ...
     */
    public synchronized static NavigationWithObstacles getNavigator() {
        if (navigator == null) {
            navigator = new NavigationWithObstacles();
        }
        return navigator;
    }
    ...
    private void travelTo(double x, double y) {
        ...
        if(state!=State.INIT) {
          ...
          System.out.println("NavigationSleep Triggered");
          return;
        }
