...
public class PController extends UltrasonicController {
	...
	public static enum State {
		...
		PASSED // When robot has completed turning
	};
...
//			}
	...
	/*
	 * if(state==INIT&&this.distance<DANGEROUS_ZONE){
	 * 
	 * state==TURNING }else if(state==TURNING){
	 * 
	 * state=PASSED }else if(state==PASSED){ state=INIT; }
	 */
